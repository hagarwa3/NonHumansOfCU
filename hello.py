...
mysql = MySQL()
app.config['MYSQL_DATABASE_USER'] = 'hidden user name'
app.config['MYSQL_DATABASE_PASSWORD'] = 'hidden pass'
app.config['MYSQL_DATABASE_DB'] = 'hidden db'
app.config['MYSQL_DATABASE_HOST'] = 'hidden link.net'
mysql.init_app(app)
conn = mysql.connect()
cursor = conn.cursor()
